<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900">
    ...
    <section class="relative overflow-hidden">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div class="text-center">
          <h1 class="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-6">
            Collaborative
            <span class="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Logging</span>
            <br>
            for Teams
          </h1>
          <p class="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
            See your team's logs in real-time. Debug together, ship faster.
            Beautiful, structured logging across Python, JavaScript, Go, Rust, and PHP.
          </p>
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <router-link
              to="/logs"
              class="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-105 shadow-lg"
            >
            ...
            <router-link
              to="/docs"
              class="border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 px-8 py-4 rounded-xl text-lg font-semibold hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 transition-all flex gap-2 items-center"
            >
      ...
      <div class="absolute top-40 right-20 w-16 h-16 bg-purple-400 rounded-full opacity-20 animate-pulse"></div>
      <div class="absolute bottom-20 left-1/4 w-12 h-12 bg-green-400 rounded-full opacity-20 animate-ping"></div>
    </section>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">
            Why Choose LogMachine?
          </h2>
          <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Built for modern development teams who need better visibility and collaboration
          </p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <!-- Feature 1 -->
          <div class="p-8 rounded-2xl border border-gray-300 dark:border-gray-600">
            ...
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Real-time Collaboration</h3>
            <p class="text-gray-600 dark:text-gray-300">
              See your team's logs as they happen. No more digging through separate log files or waiting for someone to share their output.
            </p>
          </div>

          <!-- Feature 2 -->
          <div class="p-8 rounded-2xl border border-gray-200 dark:border-gray-600">
            ...
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Beautiful Output</h3>
            <p class="text-gray-600 dark:text-gray-300">
              Color-coded logs with structured formatting. Spot errors instantly and enjoy a pleasant debugging experience.
            </p>
          </div>
          ...
          <div class="p-8 rounded-2xl border border-gray-200 dark:border-gray-600">
            ...
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Multi-Language Support</h3>
            <p class="text-gray-600 dark:text-gray-300">
              One logging platform for your entire stack. SDKs for Python, JavaScript, Go, Rust, and PHP with consistent APIs.
            </p>
          </div>

          <!-- Feature 4 -->
          <div class="p-8 rounded-2xl border border-gray-200 dark:border-gray-600">
            <div class="w-12 h-12 bg-yellow-500 rounded-xl flex items-center justify-center mb-6">
              <span class="text-white text-2xl">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6">
            ...
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Easy Setup</h3>
            <p class="text-gray-600 dark:text-gray-300">
              Get started in minutes. Use our hosted server or deploy your own. Simple configuration with sensible defaults.
            </p>
          </div>

          <!-- Feature 5 -->
          <div class="p-8 rounded-2xl border border-gray-200 dark:border-gray-600">
            <div class="w-12 h-12 bg-red-500 rounded-xl flex items-center justify-center mb-6">
              <span class="text-white text-2xl">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6">
            ...
            <p class="text-gray-600 dark:text-gray-300">
              Room-based organization keeps your logs private. Control access and share only what you need to share.
            </p>
          </div>

          <!-- Feature 6 -->
          <div class="p-8 rounded-2xl border border-gray-200 dark:border-gray-600">
            <div class="w-12 h-12 bg-indigo-500 rounded-xl flex items-center justify-center mb-6">
              <span class="text-white text-2xl">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6">
            ...
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Powerful Filtering</h3>
            <p class="text-gray-600 dark:text-gray-300">
              Search, filter, and analyze logs with advanced querying. Find issues quickly with time-based and content filters.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="py-24 bg-gray-50 dark:bg-gray-900">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-6 mb-16">
          <!-- Python -->
          <router-link to="/docs/python" class="group">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 transition-all transform hover:scale-105 text-center">
        ...
        <div class="text-center">
          <a
            href="https://github.com/logmachine"
            class="inline-flex items-center bg-white text-gray-900 px-6 py-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-all transform hover:scale-105"
          >
            Explore All SDKs →
          </a>
        </div>
    ...
    <section class="py-24 bg-white dark:bg-gray-800">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Real-time collaborative logging in your browser
          </p>
        </div>
        ...
        <div class="bg-gray-900 rounded-2xl p-8 shadow-2xl">
          <div class="flex items-center justify-between mb-6">
            ...
            <span class="text-gray-400 text-sm">Log Machine Live</span>
          </div>

          <div class="space-y-3 font-mono text-sm">
            <div class="text-green-400">
              <span class="text-blue-400">(alice @ api_server)</span> 🤌 CL Timing: [ 2024-01-15T10:30:45 ]<br>
              <span class="text-green-400">[ INFO ]</span> Server started on port 8000<br>
              <span class="text-gray-500">🏁</span>
            </div>
            <div class="text-yellow-400">
              <span class="text-blue-400">(bob @ worker)</span> 🤌 CL Timing: [ 2024-01-15T10:30:46 ]<br>
              <span class="text-yellow-400">[ WARNING ]</span> High memory usage detected<br>
              <span class="text-gray-500">🏁</span>
            </div>
            <div class="text-red-400">
              <span class="text-blue-400">(charlie @ auth_service)</span> 🤌 CL Timing: [ 2024-01-15T10:30:47 ]<br>
              <span class="text-red-400">[ ERROR ]</span> Database connection failed<br>
              <span class="text-gray-500">🏁</span>
            </div>
            <div class="text-green-400">
              <span class="text-blue-400">(alice @ api_server)</span> 🤌 CL Timing: [ 2024-01-15T10:30:48 ]<br>
              <span class="text-green-400">[ SUCCESS ]</span> User authentication successful<br>
              <span class="text-gray-500">🏁</span>
            </div>
          </div>
          ...
          <div class="mt-6 text-center">
            <router-link
              to="/logs"
              class="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-105"
            >
    ...
    <section class="py-24 bg-gradient-to-r from-blue-600 to-purple-600">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-blue-100 mb-12 max-w-2xl mx-auto">
          Join thousands of developers who are already using LogMachine to debug faster and collaborate better.
        </p>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6">
            <div class="text-3xl mb-4">1️⃣</div>
            <h3 class="text-xl font-semibold text-white mb-2">Choose Your SDK</h3>
            <p class="text-blue-100">Install LogMachine for your programming language</p>
          </div>
          <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6">
            <div class="text-3xl mb-4">2️⃣</div>
            <h3 class="text-xl font-semibold text-white mb-2">Configure Central Logging</h3>
            <p class="text-blue-100">Point to our hosted server or set up your own</p>
          </div>
          <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6">
            <div class="text-3xl mb-4">3️⃣</div>
            <h3 class="text-xl font-semibold text-white mb-2">Start Logging Together</h3>
            <p class="text-blue-100">See your team's logs in real-time</p>
          </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <router-link
            to="/logs"
            class="bg-white text-blue-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-gray-100 transition-all transform hover:scale-105 shadow-lg"
          >
            Start Logging Now
          </router-link>
          <router-link
            to="/docs"
            class="border-2 border-white text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-white hover:text-blue-600 transition-all"
          >
            📖 View Documentation
          </router-link>
        </div>
    ...
    <!-- Footer -->
    <footer class="dark:bg-gray-900 dark:text-white py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <rect class="dark:fill-[#555] fill-[#b8b5ad]" x="292" y="386" width="56" height="6" rx="3"/>
              ...
              <span class="text-xl font-bold">LogMachine</span>
            </div>
            <p class="dark:text-gray-400 text-gray-500 mb-4">
              Collaborative logging for distributed development teams.
              Built by developers, for developers. From 
<a href="https://bufferpunk.com" class="underline hover:text-black hover:dark:text-white" target="_blank" rel="noopener">Buffer Punk</a>
            </p>
            <p class="text-gray-500 text-sm">
              &copy; {{ new Date().getFullYear() }} LogMachine. Open source and free to use.
            </p>
          </div>

          <div>
            <h3 class="text-lg font-semibold mb-4">SDKs</h3>
            <ul class="space-y-2 dark:text-gray-400 text-gray-500">
              <li><router-link to="/docs/python" class="hover:text-black hover:dark:text-white transition-colors">Python</router-link></li>
              <li><router-link to="/docs/javascript" class="hover:text-black hover:dark:text-white transition-colors">JavaScript</router-link></li>
              <li><router-link to="/docs/go" class="hover:text-black hover:dark:text-white transition-colors">Go</router-link></li>
              <li><router-link to="/docs/rust" class="hover:text-black hover:dark:text-white transition-colors">Rust</router-link></li>
              <li><router-link to="/docs/php" class="hover:text-black hover:dark:text-white transition-colors">PHP</router-link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2 dark:text-gray-400 text-gray-500">
              <li><a href="https://logmachine.org/docs" class="hover:text-black hover:dark:text-white transition-colors" target="_blank" rel="noopener noreferrer">Documentation</a></li>
              <li><a href="https://logmachine.org/docs/setup" class="hover:text-black hover:dark:text-white transition-colors" target="_blank" rel="noopener noreferrer">Setup Guide</a></li>
              <li><a href="https://logmachine.org/docs/faq" class="hover:text-black hover:dark:text-white transition-colors" target="_blank" rel="noopener noreferrer">FAQ</a></li>
              <li><a href="https://github.com/logmachine" class="hover:text-black hover:dark:text-white transition-colors" target="_blank" rel="noopener noreferrer">GitHub</a></li>
              <li><a href="https://bufferpunk.com/contact" class="hover:text-black hover:dark:text-white transition-colors" target="_blank" rel="noopener noreferrer">Contact</a></li>
              <li><a href="https://bufferpunk.com" class="hover:text-black hover:dark:text-white transition-colors" target="_blank" rel="noopener noreferrer">About Buffer Punk</a></li>
            </ul>
          </div>
        </div>
      </div>
