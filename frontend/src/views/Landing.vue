<template>
  <div class="min-h-screen bg-[#fafafa] dark:bg-[#000000]">
    ...
    <section class="relative overflow-hidden">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div class="text-center">
          <h1 class="text-5xl md:text-7xl font-bold text-[#171717] dark:text-[#ffffff] mb-6">
            Collaborative
            <span>Logging</span>
            <br>
            for Teams
          </h1>
          <p class="text-xl md:text-2xl text-neutral-500 dark:text-neutral-400 mb-8 max-w-3xl mx-auto">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <router-link
              to="/logs"
              class="bg-[#171717] text-[#ffffff] dark:bg-[#ffffff] dark:text-[#000000] hover:bg-neutral-800 dark:hover:bg-neutral-100 px-8 py-4 rounded-md text-lg font-semibold transition-colors"
            >
            ...
            <router-link
              to="/docs"
              class="border border-neutral-200 dark:border-neutral-800 text-[#171717] dark:text-[#ffffff] bg-transparent hover:bg-neutral-50 dark:hover:bg-neutral-900 px-8 py-4 rounded-md text-lg font-semibold transition-colors flex gap-2 items-center"
            >
    ...
    <!-- Features Section -->
    <section class="py-24 bg-[#ffffff] dark:bg-[#000000]">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-bold text-[#171717] dark:text-[#ffffff] mb-4">
            Why Choose LogMachine?
          </h2>
          <p class="text-xl text-neutral-500 dark:text-neutral-400 max-w-2xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <!-- Feature 1 -->
          <div class="p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800/80 hover:border-neutral-400 dark:hover:border-neutral-600 transition-colors">
            <div class="w-12 h-12 bg-neutral-100 dark:bg-neutral-900 text-[#171717] dark:text-[#ffffff] rounded-lg flex items-center justify-center mb-6">
              <span class="text-2xl">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6">
            ...
            <h3 class="text-xl font-semibold text-[#171717] dark:text-[#ffffff] mb-4">Real-time Collaboration</h3>
          ...
          <div class="p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800/80 hover:border-neutral-400 dark:hover:border-neutral-600 transition-colors">
            ...
            <h3 class="text-xl font-semibold text-[#171717] dark:text-[#ffffff] mb-4">Beautiful Output</h3>
            <p class="text-neutral-500 dark:text-neutral-400">
          ...
          <div class="p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800/80 hover:border-neutral-400 dark:hover:border-neutral-600 transition-colors">
            ...
            <h3 class="text-xl font-semibold text-[#171717] dark:text-[#ffffff] mb-4">Multi-Language Support</h3>
            <p class="text-neutral-500 dark:text-neutral-400">
          ...
          <div class="p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800/80 hover:border-neutral-400 dark:hover:border-neutral-600 transition-colors">
            ...
            <h3 class="text-xl font-semibold text-[#171717] dark:text-[#ffffff] mb-4">Easy Setup</h3>
            <p class="text-neutral-500 dark:text-neutral-400">
          ...
          <div class="p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800/80 hover:border-neutral-400 dark:hover:border-neutral-600 transition-colors">
            ...
            <h3 class="text-xl font-semibold text-[#171717] dark:text-[#ffffff] mb-4">Privacy First</h3>
            <p class="text-neutral-500 dark:text-neutral-400">
          ...
          <div class="p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800/80 hover:border-neutral-400 dark:hover:border-neutral-600 transition-colors">
            ...
            <h3 class="text-xl font-semibold text-[#171717] dark:text-[#ffffff] mb-4">Powerful Filtering</h3>
            <p class="text-neutral-500 dark:text-neutral-400">
    ...
    <!-- SDK Showcase -->
    <section class="py-24 bg-[#fafafa] dark:bg-[#0a0a0a] border-t border-neutral-200/80 dark:border-neutral-800/80">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-bold text-[#171717] dark:text-[#ffffff] mb-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-6 mb-16">
          ...
          <router-link to="/docs/python" class="group">
            <div class="bg-[#ffffff] dark:bg-[#000000] p-6 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 hover:border-neutral-900 dark:hover:border-neutral-100 transition-colors text-center">
              <div class="w-16 h-16 bg-neutral-100 dark:bg-neutral-900 rounded-xl flex items-center justify-center mx-auto mb-4">
              ...
              <h3 class="text-lg font-semibold text-[#171717] dark:text-[#ffffff] mb-2">Python</h3>
              <p class="text-sm text-neutral-500 dark:text-neutral-400 font-mono">pip install logmachine</p>
            </div>
          </router-link>
          ...
          <router-link to="/docs/javascript" class="group">
            <div class="bg-[#ffffff] dark:bg-[#000000] p-6 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 hover:border-neutral-900 dark:hover:border-neutral-100 transition-colors text-center">
              ...
              <h3 class="text-lg font-semibold text-[#171717] dark:text-[#ffffff] mb-2">JavaScript</h3>
              <p class="text-sm text-neutral-500 dark:text-neutral-400 font-mono">npm install @logmachine/logmachine</p>
            </div>
          </router-link>
          ...
          <router-link to="/docs/go" class="group">
            <div class="bg-[#ffffff] dark:bg-[#000000] p-6 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 hover:border-neutral-900 dark:hover:border-neutral-100 transition-colors text-center">
              ...
              <h3 class="text-lg font-semibold text-[#171717] dark:text-[#ffffff] mb-2">Go</h3>
              <p class="text-sm text-neutral-500 dark:text-neutral-400 font-mono">go get github.com/logmachine/go</p>
            </div>
          </router-link>
          ...
          <router-link to="/docs/rust" class="group">
            <div class="bg-[#ffffff] dark:bg-[#000000] p-6 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 hover:border-neutral-900 dark:hover:border-neutral-100 transition-colors text-center">
              ...
              <h3 class="text-lg font-semibold text-[#171717] dark:text-[#ffffff] mb-2">Rust</h3>
              <p class="text-sm text-neutral-500 dark:text-neutral-400 font-mono">cargo add logmachine</p>
            </div>
          </router-link>
          ...
          <router-link to="/docs/php" class="group">
            <div class="bg-[#ffffff] dark:bg-[#000000] p-6 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 hover:border-neutral-900 dark:hover:border-neutral-100 transition-colors text-center">
              ...
              <h3 class="text-lg font-semibold text-[#171717] dark:text-[#ffffff] mb-2">PHP</h3>
              <p class="text-sm text-neutral-500 dark:text-neutral-400 font-mono">composer require bufferpunk/logmachine</p>
            </div>
          </router-link>
        </div>
        ...
        <div class="text-center">
          <a
            ...
            class="inline-flex items-center justify-center bg-[#ffffff] dark:bg-[#000000] text-[#171717] dark:text-[#ffffff] border border-neutral-200 dark:border-neutral-800 px-6 py-3 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-900 transition-colors"
          >
            Explore All SDKs →
          </a>
        </div>
    ...
    <!-- Getting Started -->
    <section class="py-24 bg-[#ffffff] dark:bg-[#0a0a0a] border-t border-neutral-200 dark:border-neutral-800">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-4xl font-bold text-[#171717] dark:text-[#ffffff] mb-8">
          Ready to Get Started?
        </h2>
        <p class="text-xl text-neutral-500 dark:text-neutral-400 mb-12 max-w-2xl mx-auto">
          Join thousands of developers who are already using LogMachine to debug faster and collaborate better.
        </p>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div class="bg-[#ffffff] dark:bg-[#000000] border border-neutral-200 dark:border-neutral-800 rounded-xl p-6">
            <div class="text-3xl mb-4">1️⃣</div>
            <h3 class="text-xl font-semibold text-[#171717] dark:text-[#ffffff] mb-2">Choose Your SDK</h3>
            <p class="text-neutral-500 dark:text-neutral-400">Install LogMachine for your programming language</p>
          </div>
          <div class="bg-[#ffffff] dark:bg-[#000000] border border-neutral-200 dark:border-neutral-800 rounded-xl p-6">
            <div class="text-3xl mb-4">2️⃣</div>
            <h3 class="text-xl font-semibold text-[#171717] dark:text-[#ffffff] mb-2">Configure Central Logging</h3>
            <p class="text-neutral-500 dark:text-neutral-400">Point to our hosted server or set up your own</p>
          </div>
          <div class="bg-[#ffffff] dark:bg-[#000000] border border-neutral-200 dark:border-neutral-800 rounded-xl p-6">
            <div class="text-3xl mb-4">3️⃣</div>
            <h3 class="text-xl font-semibold text-[#171717] dark:text-[#ffffff] mb-2">Start Logging Together</h3>
            <p class="text-neutral-500 dark:text-neutral-400">See your team's logs in real-time</p>
          </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <router-link
            to="/logs"
            class="bg-[#171717] dark:bg-[#ffffff] text-[#ffffff] dark:text-[#000000] px-8 py-4 rounded-lg text-lg font-semibold hover:bg-[#000000] dark:hover:bg-[#fafafa] transition-colors"
          >
            Start Logging Now
          </router-link>
          <router-link
            to="/docs"
            class="border border-neutral-200 dark:border-neutral-800 bg-[#ffffff] dark:bg-[#000000] text-[#171717] dark:text-[#ffffff] px-8 py-4 rounded-lg text-lg font-semibold hover:bg-neutral-50 dark:hover:bg-neutral-900 transition-colors"
          >
            📖 View Documentation
          </router-link>
        </div>
    ...
    <!-- Footer -->
    <footer class="bg-[#ffffff] dark:bg-[#000000] border-t border-neutral-200 dark:border-neutral-800 py-12 text-[#171717] dark:text-[#ffffff]">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div class="col-span-1 md:col-span-2">
            <div class="flex items-center space-x-2 mb-4">
              <div class="w-8 h-8 rounded-lg flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="50" height="50" class="">
          <!-- Machine body -->
          ...
          <rect class="dark:fill-[#555] fill-[#b8b5ad]" x="292" y="386" width="56" height="6" rx="3"/>
              ...
              <span class="text-xl font-bold text-[#171717] dark:text-[#ffffff]">LogMachine</span>
            </div>
            <p class="text-neutral-500 dark:text-neutral-400 mb-4">
              ...
              <a href="https://bufferpunk.com" class="underline text-[#171717] dark:text-[#ffffff] hover:text-neutral-600 dark:hover:text-neutral-300" target="_blank" rel="noopener">Buffer Punk</a>
            </p>
          ...
          <div>
            <h3 class="text-lg font-semibold text-[#171717] dark:text-[#ffffff] mb-4">SDKs</h3>
            <ul class="space-y-2 text-neutral-500 dark:text-neutral-400">
              <li><router-link to="/docs/python" class="hover:text-[#171717] dark:hover:text-[#ffffff] transition-colors">Python</router-link></li>
              <li><router-link to="/docs/javascript" class="hover:text-[#171717] dark:hover:text-[#ffffff] transition-colors">JavaScript</router-link></li>
              <li><router-link to="/docs/go" class="hover:text-[#171717] dark:hover:text-[#ffffff] transition-colors">Go</router-link></li>
              <li><router-link to="/docs/rust" class="hover:text-[#171717] dark:hover:text-[#ffffff] transition-colors">Rust</router-link></li>
              <li><router-link to="/docs/php" class="hover:text-[#171717] dark:hover:text-[#ffffff] transition-colors">PHP</router-link></li>
            </ul>
          </div>

          <div>
            <h3 class="text-lg font-semibold text-[#171717] dark:text-[#ffffff] mb-4">Resources</h3>
            <ul class="space-y-2 text-neutral-500 dark:text-neutral-400">
              <li><a href="https://logmachine.org/docs" class="hover:text-[#171717] dark:hover:text-[#ffffff] transition-colors" target="_blank" rel="noopener noreferrer">Documentation</a></li>
              <li><a href="https://logmachine.org/docs/setup" class="hover:text-[#171717] dark:hover:text-[#ffffff] transition-colors" target="_blank" rel="noopener noreferrer">Setup Guide</a></li>
              <li><a href="https://logmachine.org/docs/faq" class="hover:text-[#171717] dark:hover:text-[#ffffff] transition-colors" target="_blank" rel="noopener noreferrer">FAQ</a></li>
              <li><a href="https://github.com/logmachine" class="hover:text-[#171717] dark:hover:text-[#ffffff] transition-colors" target="_blank" rel="noopener noreferrer">GitHub</a></li>
              <li><a href="https://bufferpunk.com/contact" class="hover:text-[#171717] dark:hover:text-[#ffffff] transition-colors" target="_blank" rel="noopener noreferrer">Contact</a></li>
              <li><a href="https://bufferpunk.com" class="hover:text-[#171717] dark:hover:text-[#ffffff] transition-colors" target="_blank" rel="noopener noreferrer">About Buffer Punk</a></li>
            </ul>
          </div>
        </div>
      </div>
