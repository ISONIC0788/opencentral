...
class Transporter:
    ...
    Currently, it is a placeholder and does not implement any actual transport logic.
    """
...
class LogMachine(logging.Logger):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        ch = CLStreamHandler(log_parser=self.parse_log, central=self.central)
    ...
    def success(self, msg, *args, **kwargs) -> None:
        if self.isEnabledFor(self.SUCCESS):
            self._log(self.SUCCESS, msg, args, stacklevel=3, **kwargs)
